          ...
          <div className="p-8">
            <form action={action} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-navy text-white font-semibold text-[15px] py-3 rounded-md hover:bg-navy-mid transition-all hover:-translate-y-0.5 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer mt-1"
              >
