      ...
      <div className="flex-1 flex items-start justify-center py-10 px-4">
        <div className="w-full max-w-lg">
          ...
          {step === 2 && (
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 space-y-5">
              <div>
                ...
                <p className="text-text-dim text-sm">Your primary trade and location help the right tradespeople find you.</p>
              </div>
              <div>
          ...
          {step === 3 && (
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 space-y-5">
              <div>
                <h1 className="font-serif text-2xl font-bold text-navy mb-1">Tell tradespeople about you</h1>
              ...
              <div className="flex items-center justify-between p-4 bg-sm-bg rounded-xl border border-border">
                <div>
                  ...
                  <p className="text-xs text-text-dim mt-0.5">Show a badge so tradespeople know you&apos;re hiring</p>
                </div>
                <button
                  type="button"
