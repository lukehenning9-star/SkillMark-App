...
const TRADES = [
  ...
  { label: "Pipefitter", icon: <SettingsIcon /> },
...
const LEVELS = [
  {
    value: "apprentice",
    label: "Apprentice",
    description: "You're learning the trade, working under supervision, and earning while you learn. This is where every great tradesperson starts.",
  },
  {
    value: "journeyman",
    label: "Journeyman",
    description: "You're licensed and working independently. You've put in the years and earned the right to work on your own.",
  },
  {
    value: "master",
    label: "Master",
    description: "You're licensed to supervise crews, pull permits, and take full accountability for a job. The highest level in the trade.",
  },
];
  ...
  function handleNext() {
    ...
    startTransition(async () => {
      ...
      if (step === 1) {
        ...
        result = await saveProfileStep({ trade });
      } else if (step === 3) {
        ...
        // Save work experience if filled in
          ...
          {step === 1 && (
            <div className="bg-white border border-border rounded-xl shadow-sm p-8">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-xs text-text-dim">Profile photo — coming soon</p>
              </div>
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8">
              ...
              <div className="space-y-3">
                {LEVELS.map(({ value, label, description }) => (
                  ...
                  >
                    <div className={`text-sm font-bold mb-1 ${level === value ? "text-accent" : "text-navy"}`}>
                      {label}
                    </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button type="button" onClick={() => setYears((y) => Math.max(0, y - 1))}
                    className="w-9 h-9 rounded-md border border-border bg-sm-bg text-navy font-bold text-lg hover:bg-white transition-colors cursor-pointer flex items-center justify-center">
                    −
                  </button>
          ...
          {step === 5 && (
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 space-y-5">
              <div>
                ...
                <p className="text-text-dim text-sm">Optional — but profiles with work history get significantly more contractor attention.</p>
              </div>
