...
export default function SearchClient({ initialTrade = "" }: { initialTrade?: string }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="font-serif text-2xl font-bold text-navy">Find Tradespeople</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="font-semibold text-navy text-sm">No tradespeople found</p>
        ...
        <>
          <p className="text-xs text-text-dim mb-3 font-medium uppercase tracking-wide">
            {results.length} {results.length !== 1 ? "tradespeople" : "tradesperson"} found
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {results.map((profile) => (
              <Link
